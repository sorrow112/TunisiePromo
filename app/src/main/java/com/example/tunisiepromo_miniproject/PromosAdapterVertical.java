...
public class PromosAdapterVertical extends RecyclerView.Adapter<PromosAdapterVertical.ProductViewHolder> {

    private List<Promo> promoList;
    private Context context;

    public PromosAdapterVertical(List<Promo> productList, Context context) {
    ...
    public ProductViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.promo_item_vertical, parent, false);
