...
public class CategoryListingActivity extends AppCompatActivity implements SearchView.OnQueryTextListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
                            ...
                            for (DataSnapshot profileSnapshot : dataSnapshot.getChildren()) {
                                ...
                                if(menuItem.getItemId()==R.id.homeNav){
                                    if(profile.getRole().equals("vendeur")){
                                        startActivity(new Intent(CategoryListingActivity.this, MerchantDashboardActivity.class));
                                    }else{
                                        startActivity(new Intent(CategoryListingActivity.this, mainPageActivity.class));
                                    }
                                } else if (menuItem.getItemId()==R.id.searchNav) {
                                    startActivity(new Intent(CategoryListingActivity.this, RechercheActivity.class));
                                }else{
                                    if(profile.getRole().equals("vendeur")){
                                        startActivity(new Intent(CategoryListingActivity.this, MerchantProfileActivity.class));
                                    }else{
                                        startActivity(new Intent(CategoryListingActivity.this, ClientProfileActivity.class));
                                    }
                                }
                            }}
                    }
        ...
        Query query = databaseReference.orderByChild("category").equalTo(extras.getString("category"));
        title.setText("promos "+extras.getString("category"));
